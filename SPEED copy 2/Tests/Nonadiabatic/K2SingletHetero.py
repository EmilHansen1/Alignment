...
I0 = 4.2*1e-2                   # Laser intensity
B = 1.65 * 2 * np.pi *1e-3      # B constant
Bg = 1.6779 * 2 * np.pi *1e-3    # Related to V_He
...
if __name__ == '__main__':
    ...
    pf.to_csv("K3DSingletHeteroB1.65D0.05I4.2e10WFA.csv")
